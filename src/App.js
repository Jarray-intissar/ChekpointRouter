  ...
  const [movies, setMovies] = useState([
    {
      ...
      description:
        " a fierce warlord (Idris Elba) trains a young orphan (Abraham Attah) to join his group of guerrilla soldiers.",
      rating: 5,
    },
    {
    ...
    },
    {
      ...
      description:
        " Saito offers to wipe clean Cobb's criminal history as payment for performing an inception on his sick competitor's son.",
      rating: 3,
    },
    {
      name: "Shutter Island",
      ...
      description:
        " are sent to an asylum on a remote island in order to investigate the disappearance of a patient, where Teddy uncovers a shocking truth about the place.",
      rating: 5,
    },
    {
      name: "Warcraft",
    ...
    },
    {
      ...
      description:
        "The Godfather is an American film series that consists of three crime films directed by Francis Ford Coppola inspired by the 1969 .",
      rating: 5,
    },
    {
      name: "Taxi Driver",
      ...
      description:
        " One day, he is driven to save an underage prostitute from her pimp in an effort to clean the city of its corruption.",
      rating: 3,
    },
    {
      name: "Fight Club",
    ...
    },
    {
      ...
      description:
        " One day, Mehmet meets a homeless 8-year-old boy who changes his life.",
      rating: 2,
    },
    {
      name: "Seaspiracy",
      ...
      description:
        " The film premiered on Netflix globally in March 2021 and garnered immediate attention in several countries.",
      rating: 5,
    },
  ]);
